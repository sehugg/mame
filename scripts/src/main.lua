	...
	configuration { "asmjs" }
		...
		if os.getenv("EMSCRIPTEN") then
			local emccopts = ""
				...
				.. " -s EXPORTED_FUNCTIONS=\"['_main', '_malloc', '__Z13js_lua_stringPKc', '__Z14js_get_machinev', '__Z9js_get_uiv', '__Z12js_get_soundv', '__ZN15mame_ui_manager12set_show_fpsEb', '__ZNK15mame_ui_manager8show_fpsEv', '__ZN13sound_manager4muteEbh', '_SDL_PauseAudio', '_SDL_SendKeyboardKey']\""
